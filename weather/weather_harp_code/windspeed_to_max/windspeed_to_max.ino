...
float tempC, tempF, pressure_hPa, pressure_inHg, humidity, altitudeM, altitudeF;
...
void setup() {
  ...
  Serial.println("Starting wind speed sensor...");
...
void readWeatherSensorStep() {
  ...
  pressure_inHg = 29.92 * pressure_hPa / 1013.2;
...
void printStep() {
  ...
  Serial.print("Wind Speed Sensor: ");
  Serial.println();
...
void serialStep() {
  ...
  pressure_out = (unsigned int) (pressure_hPa * pressureScale);
  ...
  altitudeF_out = (unsigned int) (altitudeF * altitudeScale);
